...
/* @var $searchModel backend\models\WidgetFeatureSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Widget Features');
...
?>
<div class="widget-feature-index m-2">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a(Yii::t('app', 'Create Widget Feature'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
