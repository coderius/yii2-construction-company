...
/* @var $searchModel backend\models\WidgetFactSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Widget Facts');
...
?>
<div class="widget-fact-index m-2">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a(Yii::t('app', 'Create Widget Fact'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
