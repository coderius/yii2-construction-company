...
/* @var $searchModel backend\models\WidgetFaqSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Widget Faqs');
...
?>
<div class="widget-faq-index m-2">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a(Yii::t('app', 'Create Widget Faq'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
