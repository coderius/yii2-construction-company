...
/* @var $searchModel backend\models\WidgetSocialgallerySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Widget Socialgalleries');
...
?>
<div class="widget-socialgallery-index m-2">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a(Yii::t('app', 'Create Widget Socialgallery'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
